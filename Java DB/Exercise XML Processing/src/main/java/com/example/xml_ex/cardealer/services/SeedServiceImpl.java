...
import com.example.xml_ex.cardealer.entities.car.CarImportDTO;
import com.example.xml_ex.cardealer.entities.customer.Customer;
import com.example.xml_ex.cardealer.entities.customer.CustomerImportDTO;
import com.example.xml_ex.cardealer.entities.part.Part;
import com.example.xml_ex.cardealer.entities.part.PartImportDTO;
import com.example.xml_ex.cardealer.entities.sale.Sale;
import com.example.xml_ex.cardealer.entities.sale.SaleDiscount;
import com.example.xml_ex.cardealer.entities.supplier.Supplier;
import com.example.xml_ex.cardealer.entities.supplier.SupplierImportDTO;
import com.example.xml_ex.cardealer.repositories.*;
...
public class SeedServiceImpl implements SeedService {
    ...
    private Car set3to5RandomParts(Car car) {
        ...
        int partsCount = new Random().nextInt(3) + 3;
    ...
    private Optional<Part> getRandomPart() {
        ...
        int randomPartId = new Random().nextInt((int) partsCount) + 1;
    ...
    public void seedSales() {
        ...
        int numberOfSalas = new Random().nextInt(71) + 30;
