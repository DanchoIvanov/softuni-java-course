...
public class Main {
    public static void main(String[] args) {
        ...
        BeverageRepository<Beverages> beverageRepositoryImpl = new BeverageRepositoryImpl();
        TableRepository<Table> tableRepository = new TableRepositoryImpl();


        Controller controller = new ControllerImpl(healthFoodRepository, beverageRepositoryImpl, tableRepository);
