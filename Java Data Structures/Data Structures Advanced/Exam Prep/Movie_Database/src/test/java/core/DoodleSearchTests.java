...
public class DoodleSearchTests {
    ...
    @Test
    public void top3() {
        Doodle Doodle = new Doodle("asd", "bbbsd", 4001, true, 5.6);
        Doodle Doodle2 = new Doodle("nsd", "eesd", 4000, false, 5.6);
        Doodle Doodle3 = new Doodle("dsd", "ddsd", 5001, false, 5.7);
        Doodle Doodle4 = new Doodle("hsd", "zsd", 4000, true, 4.8);
        Doodle Doodle5 = new Doodle("qsd", "qsd", 4001, true, 4.8);
        Doodle Doodle6 = new Doodle("zsd", "ds", 5000, false, 5.4);
        ...
        List<Doodle> top3Doodles = (List<models.Doodle>) this.doodleSearch.getTop3DoodlesByRevenueThenByVisits();

        assertEquals(3, top3Doodles.size());
        assertEquals(Doodle3, top3Doodles.get(0));
        assertEquals(Doodle, top3Doodles.get(1));
        assertEquals(Doodle2, top3Doodles.get(2));
    }

    @Test
    public void top3_should_return_1() {
        Doodle Doodle = new Doodle("asd", "bbbsd", 4001, true, 5.6);
        ...
        assertEquals(1, top3Doodles.size());
        assertEquals(Doodle, top3Doodles.get(0));

    }

    @Test
    public void top3_should_return_emptyCollection() {
        Doodle Doodle = new Doodle("asd", "bbbsd", 4001, true, 5.6);

        List<Doodle> top3Doodles = (List<models.Doodle>) this.doodleSearch.getTop3DoodlesByRevenueThenByVisits();

        assertEquals(0, top3Doodles.size());
